...
public class TinderClone {
    public static void main(String[] args) {
        ...
        System.out.println("\n---- Chat Room ----");
        app.sendMessage("user1", "user2", "Hi def, Kaise ho?");
        
        app.sendMessage("user2", "user1", "Hi abc, Ma fit tum btao");
