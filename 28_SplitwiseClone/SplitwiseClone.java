...
public class SplitwiseApp {
    public static void main(String[] args) {
        ...
        System.out.println("\n=========== Creating Users ====================");
        User user1 = manager.createUser("A", "a@gmail.com");
        User user2 = manager.createUser("B", "b@gmail.com");
        User user3 = manager.createUser("C", "c@gmail.com");
        User user4 = manager.createUser("D", "d@gmail.com");
