...
class Snake extends BoardEntity {
    ...
    @Override
    public void display(){
        System.out.println("Snake: " + startPos + " => " + endPos);
    }
...
class Ladder extends BoardEntity {
    ...
    @Override
    public void display(){
        System.out.println("Ladder: " + startPos + " -> " + endPos);
    }  
...
class Board {
    ...
    public boolean canAddEntity(int pos){
        return !boardEntities.containsKey(pos);
    }
...
class StandardBoardSetupStrategy implements BoardSetupStrategy {
    ...
    public void setupBoard(Board board){
        if(board.getBoardSize() != 100){
            System.out.println("Standard setup only works for 10 * 10 board!");
            return;
        }
        ...
        if(choice == 1) {
            ...
            if(customChoice == 1) {
                ...
                for(int i = 0; i < numSnakes; i++) {
                    ...
                    strategy.addSnakePos(start, end);
                }
                ...
                for(int i = 0; i < numLadders; i++) {
                    ...
                    int start = scanner.nextInt();
                    int end = scanner.nextInt();
                    strategy.addLadderPos(start, end);
                }
